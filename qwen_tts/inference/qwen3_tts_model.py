    ...
    def generate_voice_clone(
        ...
        **kwargs,
        ...
        Args:
            ...
            instruct:
                Optional instruction(s) to control tone/style/emotion of the synthesized speech.
                E.g. "Speak in a very excited tone". If None or empty, no instruction is applied.
            non_streaming_mode:
